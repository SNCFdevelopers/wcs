...
var c = "$", a = {}, s = { enter: 13, escape: 27, space: 32, tab: 9, left: 37, up: 38, right: 39, down: 40 }, l = function (t, e, r, i) { var o = r.t + c, u = r[o]; if ((2 === r.G || 1 === r.G && !t.Z.Y) && (i["s-sc"] = u ? n(r, i.mode) : n(r)), u) {
    ...
    if ("style" === e) {
        ...
        if ("list" !== e && "type" !== e && !o && (e in t || -1 !== ["object", "function"].indexOf(typeof i) && null !== i)) {
            var c = n.nn(t);
            c && c.tn && c.tn[e] ? (m(t, e, i), u && c.tn[e].en && h(t, c.tn[e].rn, i, 4 === c.tn[e].in)) : "ref" !== e && (m(t, e, null == i ? "" : i), null != i && !1 !== i || n.Z.on(t, e));
        }
        else
            null != i && "key" !== e ? h(t, e, i) : (o || n.Z.un(t, e) && (null == i || !1 === i)) && n.Z.on(t, e);
    else
    ...
    i = new (o = n.nn(t).$n), function (n, t, e, r, i, o) { n._n.set(r, e), n.Sn.has(e) || n.Sn.set(e, {}), Object.entries(Object.assign({ color: { type: String } }, t.properties, { mode: { type: String } })).forEach(function (t) { var u = t[0], f = t[1]; (function (n, t, e, r, i, o, u, f, c) { if (t.type || t.state) {
        var a = n.Sn.get(e);
        t.state || (!t.attr || void 0 !== a[i] && "" !== a[i] || (f = o && o.Tn) && v(c = f[t.attr]) && (a[i] = O(t.type, c)), e.hasOwnProperty(i) && (void 0 === a[i] && (a[i] = O(t.type, e[i])), "mode" !== i && delete e[i])), r.hasOwnProperty(i) && void 0 === a[i] && (a[i] = r[i]), t.watchCallbacks && (a[P + i] = t.watchCallbacks.slice()), x(r, i, function s(t) { return (t = n.Sn.get(n._n.get(this))) && t[i]; }, function l(e, r) { (r = n._n.get(this)) && (t.state || t.mutable) && T(n, r, i, e, u); });
    }
    ...
    i = {}, n.kn(e, 7, t, !0);
} return n.gn.set(t, i), i; }, R = function (n, t) { for (var e = 0; e < t.childNodes.length; e++) {
...
} return !0; }, L = function (n, t, e, r, i, o) { if (n.yn.delete(t), (i = n.Mn.get(t)) && ((r = i["s-ld"]) && ((e = r.indexOf(t)) > -1 && r.splice(e, 1), r.length || i["s-init"] && i["s-init"]()), n.Mn.delete(t)), n.Rn.length && !n.yn.size)
    for (; o = n.Rn.shift();)
    ...
    t.addEventListener("e", null, Object.defineProperty({}, "passive", { get: function () { return i.Ln = !0; } }));
        ...
        n.mn.set(t, !0), L(n, t), j(n.On.get(t), !0);
        var e = n.gn.get(t);
    ...
    } })(n, this); }, e["s-init"] = function () { (function (n, t, e, r, i, o, u) { if (R(n, t) && (i = n.gn.get(t)) && !n.mn.has(t) && (!t["s-ld"] || !t["s-ld"].length)) {
        n.ct.set(t, !0), (u = n.vt.has(t)) || (n.vt.set(t, !0), t["s-ld"] = void 0, n.Z.En(t, e));
        try {
            j(n.On.get(t)), (o = n.lt.get(t)) && (o.forEach(function (n) { return n(t); }), n.lt.delete(t)), !u && i.componentDidLoad && i.componentDidLoad();
        }
        catch (e) {
            n.kn(e, 4, t);
        }
    ...
    } S(b, t, f); }); }, Cn: !1, bn: !1, st: !1, An: l, Mn: new WeakMap, K: new WeakMap, Nn: new WeakMap, ot: new WeakMap, vt: new WeakMap, ct: new WeakMap, _n: new WeakMap, jn: new WeakMap, gn: new WeakMap, mn: new WeakMap, wn: new WeakMap, lt: new WeakMap, Pn: new WeakMap, On: new WeakMap, Sn: new WeakMap, yn: new Set, Rn: [] }; return t.isServer = t.isPrerender = !(t.isClient = !0), t.window = r, t.location = r.location, t.document = i, t.resourcesUrl = t.publicPath = o, t.enableListener = function (n, t, e, r, i) { return function o(n, t, e, r, i, u) { if (t) {
    ...
    if (c && c.sn)
        if (r) {
            ...
            n.Z.cn(f, e, 1);
} }(b, n, t, e, r, i); }, b.xn = t.emit = function (n, e, r) { return h.et(n, t.eventNameFn ? t.eventNameFn(e) : e, r); }, d.h = e, d.Context = t, d.onReady = function () { return new Promise(function (n) { return b.queue.write(function () { return b.yn.size ? b.Rn.push(n) : n(); }); }); }, b.render = function (n, t) { var e, r, i, o, u, f, c, a = function (i, l, p, d, h, y, w, b, m) { if (b = l.vchildren[p], e || (o = !0, "slot" === b.vtag && (r && t.En(d, r + "-s"), b.vchildren ? b.pt = !0 : b.dt = !0)), v(b.vtext))
    b.i = t.Hn(b.vtext);
else if (b.dt)
    b.i = t.Hn("");
else {
    if (y = b.i = M || "svg" === b.vtag ? t.Fn("http://www.w3.org/2000/svg", b.vtag) : t.V(b.pt ? "slot-fb" : b.vtag), n.ft(y) && n.ct.delete(c), M = "svg" === b.vtag || "foreignObject" !== b.vtag && M, g(n, null, b, M), v(r) && y["s-si"] !== r && t.En(y, y["s-si"] = r), b.vchildren)
    ...
    } b > g ? l(n, null == i[k + 1] ? null : i[k + 1].i, r, i, m, k) : m > k && p(e, b, g); }(o, u, r, f) : v(f) ? (v(e.vtext) && t.Jn(o, ""), l(o, null, r, f, 0, f.length - 1)) : v(u) && p(u, 0, u.length - 1)), M && "svg" === r.vtag && (M = !1); }, b = function (n, e, r, i, o, u, f, c) { for (i = 0, o = (r = t.In(n)).length; i < o; i++)
    if (e = r[i], 1 === t.Dn(e)) {
        if (e["s-sr"])
        ...
        b(e);
    } }, m = [], j = function (n, e, r, o, u, f, c, a, s, l) { for (u = 0, f = (e = t.In(n)).length; u < f; u++) {
    ...
    for (j(l.i), h = 0; h < m.length; h++)
        (y = m[h]).ht["s-ol"] || ((g = t.Hn(""))["s-nr"] = y.ht, t.X(t.Gn(y.ht), y.ht["s-ol"] = g, y.ht));
    for (n.st = !0, h = 0; h < m.length; h++) {
        for (y = m[h], k = t.Gn(y.yt), $ = t.Qn(y.yt), g = y.ht["s-ol"]; g = t.Yn(g);)
            if ((M = g["s-nr"]) && M && M["s-sn"] === y.ht["s-sn"] && k === t.Gn(M) && (M = t.Qn(M)) && M && !M["s-nr"]) {
                $ = M;
                break;
            }
    ...
    n.st = !1;
} return i && b(l.i), m.length = 0, l; }; }(b, h), y["s-ld"] = [], y["s-rn"] = !0, y["s-init"] = function () { b.ct.set(y, d.loaded = b.bn = !0), h.et(r, "appload", { detail: { namespace: n } }); }, function (n, t, e, r, i, o) { if (t.componentOnReady = function (t, e) { if (!t.nodeName.includes("-"))
