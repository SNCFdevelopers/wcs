...
* Download the **SNCF** icons from the Angular exemple project : [wcs/example/src/fonts/icons](https://gitlab.com/SNCF/wcs/-/tree/master/example/src/assets/fonts/icons)
