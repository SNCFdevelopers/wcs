...
const TemplateShape: StoryFn<Partial<{ shape: WcsButtonShape, loading: boolean}>> = (args) => html`
    <wcs-button shape=${args.shape} ?loading="${args.loading}" class="wcs-primary" aria-label="Example button plain">
        <wcs-mat-icon icon="accessibility_new"></wcs-mat-icon>
    </wcs-button>
    <wcs-button shape=${args.shape} ?loading="${args.loading}" mode="clear" class="wcs-primary" aria-label="Example button clear">
        <wcs-mat-icon icon="accessibility_new"></wcs-mat-icon>
    </wcs-button>
    <wcs-button shape=${args.shape} ?loading="${args.loading}" mode="stroked" class="wcs-primary" aria-label="Example button stroked">
        <wcs-mat-icon icon="accessibility_new"></wcs-mat-icon>
    </wcs-button>
    <wcs-button shape=${args.shape} ?loading="${args.loading}" class="wcs-primary" aria-label="Example button disabled" disabled>
        <wcs-mat-icon icon="accessibility_new"></wcs-mat-icon>
    </wcs-button>
`;
