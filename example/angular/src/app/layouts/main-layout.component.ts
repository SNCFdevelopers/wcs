      ...
      <wcs-header>
        ...
        <div slot="actions">
            ...
            <div class="switch-mode">
              ...
              <wcs-switch (wcsChange)="mode.set($event.detail.checked ? 'communication' : 'business')" checked="false"></wcs-switch>
    ...
    @if (mode() === 'communication') {
      <wcs-com-nav app-name="Application" aria-label="Menu principal">
        ...
        <div slot="actions">
          ...
          <div class="switch-mode">
            <wcs-mat-icon icon="business_center" family="filled"></wcs-mat-icon>
            <wcs-switch (wcsChange)="mode.set($event.detail.checked ? 'communication' : 'business')" [checked]="mode() === 'communication'"></wcs-switch>
            <wcs-mat-icon icon="campaign" family="filled"></wcs-mat-icon>
          </div>
        </div>
      </wcs-com-nav>
...
export class MainLayoutComponent {
  mode = signal<'business' | 'communication'>('business');
