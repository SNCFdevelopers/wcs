...
const patchBrowser = async () => {
    // @ts-ignore
    const importMeta = (typeof document === 'undefined' ? new (require('u' + 'rl').URL)('file:' + __filename).href : (document.currentScript && document.currentScript.src || new URL('chunk-8ad2fb5d.js', document.baseURI).href));
    ...
    if ( (hostRef.$flags$ & 32 /* hasInitializedComponent */) === 0) {
        ...
        if ( !Cstr.$isStyleRegistered$ && Cstr.style) {
            ...
            if ( (shadowCssPolyfill || runtimeScopedCss)) {
                style = await new Promise(function (resolve) { resolve(require('./shadow-css-bbdf056f-2f07589b.js')); }).then(m => m.scopeCss(style, scopeId, false));
            }
