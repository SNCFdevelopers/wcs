...
| `state`          | `state`          | Specifies the state of the input. By default the input is in an undefined state but it is possible to set it to 'error' state if the data given by the user is not valid.        | `"error" \| "undefined"`                                                              | `'undefined'`  |
