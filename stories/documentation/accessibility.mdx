...
<div style={{display: 'flex', gap: 40, justifyContent: 'space-between'}}>
    ...
    <div>
        ...
        - alert _(no semantic needed, accessibility is well handled by the component itself)_
        - alert-drawer _(no semantic needed, slotted)_
        ...
        - card-header _(no semantic needed, slotted)_
        - card-media _(no semantic needed, slotted)_
        - card-content _(no semantic needed, slotted)_
        - card-footer _(no semantic needed, slotted)_
        - chip _(slotted, attributes are on the host element)_
        ...
        - message _(attributes are on the host element)_
