...
<table>
    ...
    <tbody>
        <tr>
            ...
            <td>
                <ul>
                    <li>`--wcs-select-native-border-color-default`: default border color</li>
                    <li>`--wcs-select-native-border-color-focus`: border color on focus</li>
                    <li>`--wcs-select-native-border-color-disabled`: border color when disabled</li>
                </ul>
            </td>
        </tr>
    </tbody>
...
<table>
    ...
    <tbody>
        <tr>
            ...
            <td>
                --wcs-badge-<mark>lighter</mark>-percentage (typo)
            </td>
        </tr>
    </tbody>
</table>
