...
const Template: StoryFn<Partial<{ activated: boolean }>> = (args) => html`
    <div role="list">
        <wcs-list-item ?activated=${args.activated} role="listitem">
            <wcs-mat-icon slot="icon" icon="description"></wcs-mat-icon>
            <div slot="title">Titre premier item</div>
            <div slot="actions">
                <wcs-button shape="square" mode="stroked" class="wcs-secondary" aria-label="Ouvrir dans un nouvel onglet">
        ...
        <wcs-list-item role="listitem">
            ...
            <div slot="actions">
                <wcs-button shape="square" mode="stroked" class="wcs-secondary" aria-label="Créer">
