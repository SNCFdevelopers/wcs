...
function Root() {
  const [isBusinessNavActive, setIsBusinessNavActive] = useState(true);
    ...
    return (
        <AlertDrawerProvider config={{position: 'top-right', showProgressBar: true, timeout: 4000}}>
            <div className="App">
                {isBusinessNavActive ? (
                    ...
                    <main>
                        <section>
                            ...
                            <div className="switch-mode">
                                ...
                                <WcsSwitch checked={isBusinessNavActive}
                                           onWcsChange={() => setIsBusinessNavActive(!isBusinessNavActive)}>
                                </WcsSwitch>
