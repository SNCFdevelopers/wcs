...
<table>
    ...
    <tr>
        ...
        <td>
            - `--wcs-semantic-color-background-surface-warning-default` for representing warnings.
        </td>
    </tr>
    <tr>
        <td>
        ...
        <td>
            - `--wcs-semantic-color-background-surface-success-default` for representing success states.
        </td>
    </tr>
    </tbody>
</table>
